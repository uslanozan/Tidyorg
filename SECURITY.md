...
EN — We provide security updates for the current major version and the immediately preceding major version.
TR — Mevcut ana sürüm ve bir hemen önceki ana sürüm için güvenlik güncellemeleri sağlıyoruz.
...
--TODO : burası şirket akışına daha iyi uyarlanabilir--
EN — 1. Email your findings directly to `security@tidyorg.digital`.
TR — 1. Bulgularınızı doğrudan `security@tidyorg.digital` adresine e-posta ile gönderin.
